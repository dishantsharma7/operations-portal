...
const writerCompanyRegisterService = async (writerCompanyRegistrationData: writerCompanyRegisterInterface) => {
  ...
  const registrationResponse = await authMethods.RegisterWriterCompanyMethod(writerCompanyRegistrationData);
  return registrationResponse;
};

const writerCompanyLoginService = async (emailAddress: string, password: string) => {
